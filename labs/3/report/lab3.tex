...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.65\textwidth]{latex_report/LaserScan.png} % Include the image placeholder.png
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.65\textwidth]{latex_report/WallEstimation.png} % Include the image placeholder.png
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.65\textwidth]{latex_report/Unideal.png} % Include the image placeholder.png
...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.4\linewidth]{latex_report/InsideCorner.png}
  \caption{Inside corner example}
  \label{fig:sub1}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.4\linewidth]{latex_report/OutsideCorner.png}
...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.6\linewidth]{latex_report/Protruding.png}
  \caption{Protruding feature}
  \label{fig:sub1}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.6\linewidth]{latex_report/Inset.png}
...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.6\linewidth]{latex_report/TightInside.png}
  \caption{Extreme inside corner}
  \label{fig:sub1}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.6\linewidth]{latex_report/TightOutside.png}
...
\subsubsection{Handling Multiple Speeds}
 ...
 \begin{figure}[h]
\begin{center}
\includegraphics[width=0.65\textwidth]{latex_report/SafeRobot.png} % Include the image placeholder.png
